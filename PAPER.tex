...
the mean-field limit --- provably independent of it. The two faces, and the single
bridge lemma that identifies them, are visible in the Lean: the dual is a supremum
over $1$-Lipschitz tests (the \lean{⨆} in the code below), the primal an infimum
over couplings (the \lean{⨅}), and Kantorovich--Rubinstein duality is their
equality.
\begin{leancode}
